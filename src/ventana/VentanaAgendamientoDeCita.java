...
//        JOptionPane.showMessageDialog(this, "Propietario o mascota no encontrado");
//        return;
//    }
//
...
//    }
//
//    // Verificar si el veterinario esta disponible
//    if (!veterinario.isDisponible()) {
//        JOptionPane.showMessageDialog(this, "El veterinario seleccionado no esta disponible");
//        return;
//    }
//
...
//     // Agregar al historial clinico de la mascota
//    mascota.guardarEvento(nuevaCita);
//
//    // Mostrar mensaje 
...
//            if (propi.getNombreP().equalsIgnoreCase(nombreP)) {
//                propietario = propi;
//                for (Mascota m : propi.getListaMascotas()) {
