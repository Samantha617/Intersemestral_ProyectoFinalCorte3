...
//            Consulta consultaElimi = Consulta.buscarConsulta(codigo);
//            boolean eliminado = Consulta.eliminarConsulta(codigo);
//
//            if (eliminado) {
//                // También eliminar del historial de la mascota
//                Mascota mascota = consultaElimi.getMascota(); // su mascota asociada
//                mascota.getHistorial().remove(consultaElimi); // eliminar del historial de eventos
//
