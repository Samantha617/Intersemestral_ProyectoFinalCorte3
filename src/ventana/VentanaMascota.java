...
//---------------Constructor de la ventana-------------------------------
    ...
    private void initComponents() {
        ...
        txtNombrePropietario.setBackground(new java.awt.Color(0, 153, 102));
        ...
        jLabel8.setText("N. Documento Propietario: ");

        txtNumeroDocumento.setBackground(new java.awt.Color(0, 153, 102));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtNombrePropietario, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(27, 27, 27))
        );
        ...
        tblMascotas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre de la Mascota", "Especie", "Edad", "Raza", "Peso", "N.Documento Propietario", "Nombre del Propietario"
            }
        ) {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (nombreM.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor ingresa un nombre de mascota para buscar.");
            return;
        }
        ...
        if (encontrada != null) {
            ...
            cbEspecie.setSelectedItem(encontrada.getEspecie()); // Como especie es un JComboBox, usamos setSelectedItem
            ...
            txtNumeroDocumento.setText(encontrada.getPropietario().getNumeroDocumento());
            txtNombrePropietario.setText(encontrada.getPropietario().getNombreP());
        } else {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       try {
        ...
        controladorMasco.guardarMascota(nombreM, especie, edad, raza, peso, documento, nombrePropietario);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (nombreM.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, ingresa el nombre de la mascota a eliminar.");
            return;
        }

        int confirm = JOptionPane.showConfirmDialog(this, "¿Seguro que deseas eliminar a " + nombreM + "?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (eliminado) {
                ...
                JOptionPane.showMessageDialog(this, "No se encontró la mascota para eliminar");
            }
        }
...
//------------creo metodo de llenar tabla------------------------
    ...
    private void llenarTabla() {
        // Obtener el modelo de la tabla que ya fue configurado desde el diseñador
        DefaultTableModel modelo = (DefaultTableModel) tblMascotas.getModel();
        modelo.setRowCount(0); // Limpiar la tabla

        for (MascotaDTO m : daoMasco.listar()) {
            modelo.addRow(new Object[]{
                ...
                m.getRaza(),
                m.getPeso(),
                m.getPropietario() != null ? m.getPropietario().getNumeroDocumento() : "",
                m.getPropietario() != null ? m.getPropietario().getNombreP() : "Sin propietario"
